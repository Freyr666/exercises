...
Proof.
  intros c.
  split; intros H.
  - inversion H. inversion H5. rewrite H8 in H2. assumption.
  - apply E_Seq with st'.
    + apply H.
    + apply E_Skip.
Qed.
...
Proof.
  ...
  - inversion H. 
    ...
    + apply E_IfTrue.
      simpl. rewrite H5. reflexivity.
      apply H6.
  - inversion H; simpl in H5.
    + apply (negb_true (beval st b)) in H5. apply E_IfFalse.
      apply H5. apply H6.
    + apply (negb_false (beval st b)) in H5. apply E_IfTrue.
      apply H5. apply H6.
Qed.
