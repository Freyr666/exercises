...
Proof.
  ...
  - apply hoare_consequence with P' Q'.
    apply IHX.
    intros st HP. apply p. apply HP.
    intros st HQ. apply q. apply HQ.
Qed.
...
Proof.
  ...
  - (* If *)
    apply H_If.
    + apply IHc1. intros st st' H [HP Hb].
      apply HT with st. inversion Hb.
      eapply E_IfTrue in H1. apply H1. apply H. apply HP.
